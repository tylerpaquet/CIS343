...
SELECT RANK(30000) WITHIN GROUP (ORDER BY salary asc) "Rank of 30000" 
FROM employee;
...
SELECT RANK(31000) WITHIN GROUP (ORDER BY salary asc) "Rank of 31000" 
FROM employee;
...
SELECT DENSE_RANK(30000) WITHIN GROUP (ORDER BY salary asc) "Dense Rank of 30000" 
FROM employee;
...
SELECT DENSE_RANK(31000) WITHIN GROUP (ORDER BY salary asc) "Dense Rank of 31000" 
FROM employee;
